...
function library.notify(message, time, color)
    ...
    do
        ...
        notification.holder = Drawing.new('Square', {
        ...
        notification.border1 = Drawing.new('Square', {
        ...
        objs.border2 = Drawing.new('Square', {
            Size = UDim2.new(1,2,1,2);
            Position = UDim2.new(0,-1,0,-1);
        ...
        notification.gradient = Drawing.new('Image', {
            Size = UDim2.new(1,0,1,0);
        ...
        notification.accentBar = Drawing.new('Square',{
        ...
        notification.accentBottomBar = Drawing.new('Square',{
...
do  
    local z = 10;
    tooltip_objects.holder = Drawing.new('Square', {
        Position = UDim2.new(0, 0, 0, 75);
        Transparency = 0;
        Thickness = 1;
    })
    
    tooltip_objects.background = Drawing.new('Square', {
        Size = UDim2.new(1,0,1,0);
        Position = UDim2.new(0, -500, 0, 0);
    ...
    tooltip_objects.border1 = Drawing.new('Square', {
        Size = UDim2.new(1,2,1,2);
        Position = UDim2.new(0,-1,0,-1);
        Color = Color3.fromRGB(50,50,50);
    ...
    tooltip_objects.border2 = Drawing.new('Square', {
        Size = UDim2.new(1,2,1,2);
        Position = UDim2.new(0,-1,0,-1);
        Color = Color3.fromRGB(0,0,0);
    ...
    tooltip_objects.gradient = Drawing.new('Image', {
        Size = UDim2.new(1,0,1,0);
        Data = images.gradient90;
        Parent = tooltip_objects.background;
        Transparency = .5;
    ...
    tooltip_objects.accentBar = Drawing.new('Square',{
        Size = UDim2.new(0,1,1,1);
        Position = UDim2.new(0,-1,0,0);
        Parent = tooltip_objects.background;
        Theme = color == nil and 'Accent' or '';
    ...
    tooltip_objects.text = Drawing.new('Text', {
        Position = UDim2.new(0,5,0,2);
        Theme = 'Text';
        Text = "";
        Outline = true;
...
function library.object_colorpicker(default, defaultalpha, parent, count, flag, callback, offset)
    ...
    local saturation = Drawing.new("Square", {
        Filled = true,
        Thickness = 0,
        Parent = window,
        Color = default,
    ...
    local saturationpicker = Drawing.new("Square", {
        Filled = true,
        Thickness = 0,
        Parent = saturation,
    ...
    local hueframe = Drawing.new("Square", {
        Filled = true,
        Thickness = 0,
        Parent = window,
    ...
    local alphaframe = Drawing.new("Square", {
        Filled = true,
        Thickness = 1,
        Size = UDim2.new(0, 15, 0, 150),
    ...
    local alphapicker = Drawing.new("Square", {
        Filled = true,
        Thickness = 0,
        Parent = alphaframe,
        Color = Color3.fromRGB(255, 255, 255),
    ...
    local rgbinput = Drawing.new("Square", {
        Filled = true,
        Transparency = 1,
        Thickness = 1,
        Color = Color3.fromRGB(13,13,13),
    ...
    local paste = Drawing.new("Square", {
        Filled = true,
        Transparency = 1,
        Thickness = 1,
        Color = Color3.fromRGB(13,13,13),
...
function library.object_dropdown(holder, content, flag, callback, default, max, scrollable, scrollingmax, section)
    local dropdown = Drawing.new("Square", {
        Filled = true,
        Visible = true,
        Thickness = 1,
        Color = Color3.fromRGB(13,13,13),
    ...
    local icon = Drawing.new("Image", {Data = images.arrow_down, Transparency = 0.5, Visible = true, Parent = dropdown, Size = UDim2.new(0,9,0,6), ZIndex = 9, Position = UDim2.new(1, -13, 0, 4)});

    local contentframe = Drawing.new("Square", {
        Filled = true,
        Visible = false,
        Thickness = 1,
        Color = Color3.fromRGB(13,13,13),
    ...
    local contentholder = Drawing.new("Square", {
        Transparency = 0,
...
function library:init_window(cfg)
    ...
    -- drawings
    local window_main = Drawing.new("Square", {Size = UDim2.new(0,size_X,0,size_Y), Position = utility.getcenter(size_X,size_Y), Color = Color3.fromRGB(12,12,9), Thickness = 1, Filled = true, ZIndex = 2}); do
    ...
    --
    local window_top = Drawing.new("Square", {Size = UDim2.new(1,0,0,30), Position = UDim2.new(0,0,0,0), Color = Color3.fromRGB(25,25,25), Thickness = 1, Filled = true, ZIndex = 3, Parent = window_main}); do
        ...
        Drawing.new("Image", {Size = UDim2.new(1, 0, 1, 0),Transparency = 1,ZIndex = 4,Parent = window_top,Data = images.gradient180})
    end;
    local window_drag = Drawing.new("Square", {Parent = window_main, Visible = true, Transparency = 0, Size = UDim2.new(1,0,0,30), Position = UDim2.new(0,0,0,0), Thickness = 1, Filled = true, ZIndex = 10})
    --
    local window_title = Drawing.new("Text", {Text = window_name, Parent = window_top, Visible = true, Transparency = 1, Color = Color3.new(1,1,1), Size = 13, Center = true, Outline = false, Font = Drawing.Fonts.Plex, Position = UDim2.new(0.5,0,0.5,-6), ZIndex = 6});
    local window_title_shadow = Drawing.new("Text", {Text = window_name, Parent = window_top, Visible = true, Transparency = 1, Color = Color3.new(0,0,0), Size = 13, Center = true, Outline = false, Font = Drawing.Fonts.Plex, Position = UDim2.new(0.5,0,0.5,-5), ZIndex = 5});
    --
    local window_bottom = Drawing.new("Square", {Size = UDim2.new(1,0,0,30), Position = UDim2.new(0,0,1,-30), Color = Color3.fromRGB(25,25,25), Thickness = 1, Filled = true, ZIndex = 3, Parent = window_main}); do
    ...
    local bottom_holder = Drawing.new("Square", {Parent = window_bottom, Visible = true, Transparency = 0, Size = UDim2.new(1,-2,1,-2), Position = UDim2.new(0,1,0,2), Thickness = 1, Filled = true, ZIndex = 4})
    local bottom_accent_line = Drawing.new("Square", {Parent = window_bottom, Visible = true, Transparency = 1, Size = UDim2.new(0,0,0,2), Position = UDim2.new(0,0,0,0), Thickness = 1, Filled = true, ZIndex = 4, Theme = "Accent"})
    local window_resize = Drawing.new("Square", {Parent = window_main, Visible = true, Transparency = 0, Size = UDim2.new(0,10,0,10), Position = UDim2.new(1,-10,1,-10), Thickness = 1, Filled = true, ZIndex = 10})
    --
    local dragoutline = Drawing.new("Square", {Size = UDim2.new(0, size_X, 0, size_Y),Position = utility.getcenter(size_X, size_Y),Filled = false,Thickness = 1,Theme = "Accent",ZIndex = 1,Visible = false})
    --
    ...
    -- // ESP PREVIEW
    local esp_preview_window = Drawing.new("Square", {Parent = window_main; Size = UDim2.new(0, 231, 0, 339), Position = UDim2.new(1, 10, 0, 0), Color = Color3.fromRGB(12,12,9), Thickness = 1, Filled = true, ZIndex = 2}); do
        local inline_outline = utility.outline(esp_preview_window, Color3.fromRGB(50,50,50), 4);
        utility.outline(inline_outline, Color3.fromRGB(0,0,0), 4);

        local window_title = Drawing.new("Text", {Text = "ESP Preview", Parent = esp_preview_window, Visible = true, Transparency = 1, Color = Color3.new(12,12,9), Size = 13, Center = false, Outline = false, Font = Drawing.Fonts.Plex, Position = UDim2.new(0,6,0,3), ZIndex = 6});
        local inner_window = Drawing.new("Square", {Parent = esp_preview_window; Size = UDim2.new(0,219,0,313); Position = UDim2.new(0,6,0,19), Color = Color3.fromRGB(15,15,15), Thickness = 1, Filled = true, ZIndex = 2}); do  
            local inline_outline = utility.outline(inner_window, Color3.fromRGB(50,50,50), 4);
            utility.outline(inline_outline, Color3.fromRGB(0,0,0), 4);
        end;

        -- // ESP head
        local esp_head = Drawing.new("Square", {Parent = inner_window; Size = UDim2.new(0, 45, 0, 39), Position = UDim2.new(0, 91, 0, 85), Color = Color3.fromRGB(255, 255, 255), Thickness = 1, Filled = true, ZIndex = 5}); 
        local esp_head_outline = utility.outline(esp_head, Color3.fromRGB(0, 0, 0), 4);

        -- // Toros
        local esp_torso = Drawing.new("Square", {Parent = inner_window; Size = UDim2.new(0, 147, 0, 77), Position = UDim2.new(0, 39, 0, 125), Color = Color3.fromRGB(255, 255, 255), Thickness = 1, Filled = true, ZIndex = 5});
        local esp_torso_outline = utility.outline(esp_torso, Color3.fromRGB(0, 0, 0), 4);
        

        -- // Legs
        local esp_legs = Drawing.new("Square", {Parent = inner_window; Size = UDim2.new(0, 73, 0, 78), Position = UDim2.new(0, 77, 0, 203), Color = Color3.fromRGB(255, 255, 255), Thickness = 1, Filled = true, ZIndex = 5});
        ...
        -- // Bounding box
        local esp_bounding_box = Drawing.new("Square", {Parent = inner_window; Size = UDim2.new(0, 195, 0, 236), Position = UDim2.new(0, 13.4, 0, 40), Color = Color3.fromRGB(255, 255, 255), Thickness = 1, Filled = false, ZIndex = 5}); 
        local esp_bounding_box_outline = utility.outline(esp_bounding_box, Color3.fromRGB(0, 0, 0), 4);

        -- // Healthbar
        local esp_health_bar = Drawing.new("Square", {Parent = inner_window; Size = UDim2.new(0, 2, 0, 236), Position = UDim2.new(0, 8, 0, 40), Color = Color3.fromRGB(0, 255, 42), Thickness = 1, Filled = true, ZIndex = 5});
        local esp_health_bar_outline = utility.outline(esp_health_bar, Color3.fromRGB(0, 0, 0), 4);

        -- // Text
        local esp_name = Drawing.new("Text", {Text = "OnlyTwentyCharacters", Parent = inner_window, Visible = false, Transparency = 1, Color = Color3.fromRGB(255, 255, 255), Size = 13, Center = true, Outline = true, Font = Drawing.Fonts.Plex, Position = UDim2.new(0, 115, 0, 25), ZIndex = 6});
        local esp_distance = Drawing.new("Text", {Text = "0 meters", Parent = inner_window, Visible = false, Transparency = 1, Color = Color3.fromRGB(255, 255, 255), Size = 13, Center = true, Outline = true, Font = Drawing.Fonts.Plex, Position = UDim2.new(0, 115, 0, 276), ZIndex = 6});
        local esp_weapon = Drawing.new("Text", {Text = "Weapon", Parent = inner_window, Visible = false, Transparency = 1, Color = Color3.fromRGB(255, 255, 255), Size = 13, Center = true, Outline = true, Font = Drawing.Fonts.Plex, Position = UDim2.new(0, 115, 0, 286), ZIndex = 6});
    ...
    function window_table:create_page(cfg)
        ...
        -- drawingsf
        local page_button = Drawing.new("Square", {Color = Color3.fromRGB(20,20,20), Thickness = 1, Filled = true, ZIndex = 6, Parent = bottom_holder}); do
            local inline_outline_page = utility.outline(page_button, Color3.fromRGB(0,0,0), 6);
            Drawing.new("Image", {Size = UDim2.new(1, 0, 1, 0),Transparency = 1,ZIndex = 6,Parent = page_button,Data = images.gradient90})
        end;
        table.insert(self.buttons, page_button)
        local page_title = Drawing.new("Text", {Text = page_name, Parent = page_button, Visible = true, Transparency = 0.5, Color = Color3.new(1,1,1), Size = 13, Center = true, Outline = false, Font = Drawing.Fonts.Plex, Position = UDim2.new(0.5,0,0.5,-7), ZIndex = 7});
        local page_title_shadow = Drawing.new("Text", {Text = page_name, Parent = page_button, Visible = true, Transparency = 1, Color = Color3.new(0,0,0), Size = 13, Center = true, Outline = false, Font = Drawing.Fonts.Plex, Position = UDim2.new(0.5,0,0.5,-6), ZIndex = 6});
        table.insert(self.titles, page_title)
        --
        local page = Drawing.new("Square", {Parent = window_main, Visible = false, Transparency = 0, Size = UDim2.new(1,-20,1,-80), Position = UDim2.new(0,10,0,40), Thickness = 1, Filled = false, ZIndex = 4}) do
            table.insert(self.pages, page);
        end;
        --
        local left = Drawing.new("Square", {Color = Color3.fromRGB(22,22,22),Transparency = 0,Filled = true,Thickness = 1,ZIndex = 6,Parent = page,Size = UDim2.new(0.5, -6, 1, 0);})
        left:AddListLayout(8) 
        local right = Drawing.new("Square", {Color = Color3.fromRGB(22,22,22),Transparency = 0,Filled = true,Thickness = 1,Parent = page,ZIndex = 6,Size = UDim2.new(0.5, -6, 1, 0),Position = UDim2.new(0.5, 6, 0, 0);})
        ...
        function page_table:new_section(cfg)
            ...
            -- drawings
            local section = Drawing.new("Square", {Color = Color3.fromRGB(22,22,22),Transparency = 1,Filled = true,Thickness = 1,ZIndex = 6,Parent = section_side,Size = UDim2.new(1,0,0, section_size);}) do
            ...
            --
            local section_top = Drawing.new("Square", {Size = UDim2.new(1,0,0,30), Position = UDim2.new(0,0,0,0), Color = Color3.fromRGB(25,25,25), Thickness = 1, Filled = true, ZIndex = 6, Parent = section}); do
                ...
                Drawing.new("Image", {Size = UDim2.new(1, 0, 1, 0),Transparency = 1,ZIndex = 6,Parent = section_top,Data = images.gradient90})
            end;
            --
            local section_title = Drawing.new("Text", {Text = section_name, Parent = section_top, Visible = true, Transparency = 1, Color = Color3.new(1,1,1), Size = 13, Center = true, Outline = false, Font = Drawing.Fonts.Plex, Position = UDim2.new(0.5,0,0.5,-6), ZIndex = 7});
            local section_title_shadow = Drawing.new("Text", {Text = section_name, Parent = section_top, Visible = true, Transparency = 1, Color = Color3.new(0,0,0), Size = 13, Center = true, Outline = false, Font = Drawing.Fonts.Plex, Position = UDim2.new(0.5,0,0.5,-5), ZIndex = 6});
            --
            local content = Drawing.new("Square", {Transparency = 0,Size = UDim2.new(1, -32, 1, -45),Position = UDim2.new(0, 16, 0, 40),Parent = section,ZIndex = 6, Thickness = 1});
            ...
            function section_table:new_container(cfg)
                ...
                -- drawings
                local holder = Drawing.new("Square", {Parent = content, Visible = true, Transparency = 0, Size = UDim2.new(1,0,0,8), Thickness = 1, Filled = true, ZIndex = 7});
                --
                if allow_tool then
                    tooltip(cfg, tooltip_text, holder)
                end
                --
                local button = Drawing.new("Square", {Parent = holder, Visible = true, Transparency = 0, Size = UDim2.new(1,0,0,8), Thickness = 1, Filled = true, ZIndex = 7});
                --
                local title = Drawing.new("Text", {Text = name, Parent = holder, Visible = true, Transparency = 1, Color = Color3.new(1,1,1), Size = 13, Center = false, Outline = false, Font = Drawing.Fonts.Plex, Position = UDim2.new(0,0,0,-3), ZIndex = 7});
                local title_shadow = Drawing.new("Text", {Text = name, Parent = holder, Visible = true, Transparency = 1, Color = Color3.new(0,0,0), Size = 13, Center = false, Outline = false, Font = Drawing.Fonts.Plex, Position = UDim2.new(0,0,0,-2), ZIndex = 6});
                --
                local icon = Drawing.new("Image", {Data = open and images.arrow_up or images.arrow_down, Transparency = 0.5, Visible = true, Parent = holder, Size = UDim2.new(0,9,0,6), ZIndex = 9, Position = UDim2.new(1, -13, 0, 2)});
                --
                local multicontent = Drawing.new("Square", {Visible = false, Transparency = 0,Size = UDim2.new(1, -30, 0, actualsize),Position = UDim2.new(0, 15, 0, 15),Parent = holder,ZIndex = 6, Thickness = 1});
                ...
                function container_tbl:new_container(cfg)
                    ...
                    local tooltip_text = cfg.tip_text or cfg.Tip_Text or '';
                    -- drawings
                    local multi_holder = Drawing.new("Square", {Parent = multicontent, Visible = true, Transparency = 0, Size = UDim2.new(1,0,0,8), Thickness = 1, Filled = true, ZIndex = 7});
                    --
                    if allow_tool then
                        tooltip(cfg, tooltip_text, multi_holder)
                    end
                    local multi_button = Drawing.new("Square", {Parent = multi_holder, Visible = true, Transparency = 0, Size = UDim2.new(1,0,0,8), Thickness = 1, Filled = true, ZIndex = 7});
                    --
                    local multi_title = Drawing.new("Text", {Text = multi_name, Parent = multi_holder, Visible = true, Transparency = 1, Color = Color3.new(1,1,1), Size = 13, Center = false, Outline = false, Font = Drawing.Fonts.Plex, Position = UDim2.new(0,0,0,-3), ZIndex = 7});
                    local multi_title_shadow = Drawing.new("Text", {Text = multi_name, Parent = multi_holder, Visible = true, Transparency = 1, Color = Color3.new(0,0,0), Size = 13, Center = false, Outline = false, Font = Drawing.Fonts.Plex, Position = UDim2.new(0,0,0,-2), ZIndex = 6});
                    --
                    local multi_icon = Drawing.new("Image", {Data = multi_open and images.arrow_up or images.arrow_down, Transparency = 0.5, Visible = true, Parent = multi_holder, Size = UDim2.new(0,9,0,6), ZIndex = 9, Position = UDim2.new(1, -13, 0, 2)});
                    --
                    local multi_multicontent = Drawing.new("Square", {Visible = false, Transparency = 0,Size = UDim2.new(1, -30, 0, multi_actualsize),Position = UDim2.new(0, 15, 0, 15),Parent = multi_holder,ZIndex = 6, Thickness = 1});
                    ...
                    function multi_container_tbl:new_toggle(cfg)
                        ...
                        local toggled = false;
                        -- drawings
                        local holder = Drawing.new("Square", {Parent = multi_multicontent, Visible = true, Transparency = 0, Size = UDim2.new(1,0,0,8), Thickness = 1, Filled = true, ZIndex = 7});
                        if allow_tool then
                            tooltip(cfg, tooltip_text, holder)
                        end
                        --
                        local toggle_frame = Drawing.new("Square", {Parent = holder, Visible = true, Transparency = 1, Color = Color3.fromRGB(65,65,65), Size = UDim2.new(0,8,0,8), Thickness = 1, Filled = true, ZIndex = 7}) do
                            local outline = utility.outline(toggle_frame, Color3.fromRGB(85,85,85), 7);
                            utility.outline(outline, Color3.fromRGB(0,0,0), 7);
                        end;
                        local accent = Drawing.new("Square", {Parent = toggle_frame, Visible = true, Transparency = 0, Size = UDim2.new(1,0,1,0), Position = UDim2.new(0,0,0,0), Thickness = 1, Filled = true, ZIndex = 7, Theme = "Accent"})
                        --
                        local toggle_title = Drawing.new("Text", {Text = toggle_name, Parent = holder, Visible = true, Transparency = 1, Color = toggle_risky and Color3.fromRGB(255, 57, 57) or Color3.new(1,1,1), Size = 13, Center = false, Outline = false, Font = Drawing.Fonts.Plex, Position = UDim2.new(0,13,0,-3), ZIndex = 7});
                        local toggle_title_shadow = Drawing.new("Text", {Text = toggle_name, Parent = holder, Visible = true, Transparency = 1, Color = Color3.new(0,0,0), Size = 13, Center = false, Outline = false, Font = Drawing.Fonts.Plex, Position = UDim2.new(0,13,0,-2), ZIndex = 6});
                        -- functions
                        ...
                        function toggletypes:new_slider(cfg)
                            ...
                            local val = default;
                            -- drawings
                            local slider_holder = Drawing.new("Square", {Parent = holder, Visible = true, Transparency = 0, Size = UDim2.new(1,0,0,15), Thickness = 1, Filled = true, ZIndex = 2});
                            --
                            local slider_frame = Drawing.new("Square",{
                                Color = Color3.fromRGB(13,13,13),
                            ...
                            --
                            local slider_value = Drawing.new("Text", {Text = text, Parent = slider_frame, Visible = true, Transparency = 1, Color = Color3.new(1,1,1), Size = 13, Center = true, Outline = true, Font = Drawing.Fonts.Plex, Position = UDim2.new(0.5,0,0.5,-6), ZIndex = 8});
                            --
                            local slider_fill = Drawing.new("Square", {Parent = slider_frame, Visible = true, Transparency = 1, Theme = "Accent", Size = UDim2.new(1,0,1,0), Thickness = 1, Filled = true, ZIndex = 7, Position = UDim2.new(0,0,0,0)});
                            local slider_drag_bar = Drawing.new("Square", {Parent = slider_fill, Visible = true, Transparency = 1, Color = Color3.new(1,1,1), Size = UDim2.new(0,2,1,6), Thickness = 1, Filled = true, ZIndex = 7, Position = UDim2.new(1,0,0,-3)});
                            --
                            local slider_drag = Drawing.new("Square", {Parent = slider_frame, Color = Color3.new(0.074509, 0.074509, 0.074509), Visible = true, Transparency = 0, Size = UDim2.new(1,0,1,0), Thickness = 1, Filled = true, ZIndex = 8, Position = UDim2.new(0,0,0,0)});
                            --[[
                            local minus = Drawing.new("Text", {Text = "-", Parent = holder, Visible = true, Transparency = 1, Color = Color3.new(1,1,1), Size = 13, Center = false, Outline = true, Font = Drawing.Fonts.Plex, Position = UDim2.new(0,0,0,10), ZIndex = 7});
                            local plus = Drawing.new("Text", {Text = "+", Parent = holder, Visible = true, Transparency = 1, Color = Color3.new(1,1,1), Size = 13, Center = false, Outline = true, Font = Drawing.Fonts.Plex, Position = UDim2.new(1,-6,0,10), ZIndex = 7});
                            --
                            local minus_detect = Drawing.new("Square", {Parent = holder, Visible = true, Transparency = 0, Size = UDim2.new(0,14,0,14), Thickness = 1, Filled = true, ZIndex = 7, Position = UDim2.new(minus.Position.X.Scale, minus.Position.X.Offset,minus.Position.Y.Scale,minus.Position.Y.Offset)});
                            local plus_detect = Drawing.new("Square", {Parent = holder, Visible = true, Transparency = 0, Size = UDim2.new(0,14,0,14), Thickness = 1, Filled = true, ZIndex = 7, Position = UDim2.new(plus.Position.X.Scale, plus.Position.X.Offset,plus.Position.Y.Scale,plus.Position.Y.Offset)});
                            -- functions]]
                    ...
                    function multi_container_tbl:new_slider(cfg)
                        ...
                        local tooltip_text = cfg.tip_text or cfg.Tip_Text or '';
                        -- drawings
                        local holder = Drawing.new("Square", {Parent = multi_multicontent, Visible = true, Transparency = 0, Size = UDim2.new(1,0,0,15), Thickness = 1, Filled = true, ZIndex = 7});
                        --
                        if allow_tool then
                            tooltip(cfg, tooltip_text, holder)
                        end
                        ...
                        utility.outline(outline, Color3.fromRGB(0,0,0), 6)
                        --
                        local slider_title = Drawing.new("Text", {Text = name, Parent = holder, Visible = true, Transparency = 1, Color = Color3.new(1,1,1), Size = 13, Center = false, Outline = false, Font = Drawing.Fonts.Plex, Position = UDim2.new(0,155,0,0), ZIndex = 7});
                        local slider_title_shadow = Drawing.new("Text", {Text = name, Parent = holder, Visible = true, Transparency = 1, Color = Color3.new(0,0,0), Size = 13, Center = false, Outline = false, Font = Drawing.Fonts.Plex, Position = UDim2.new(0,155,0,1), ZIndex = 6});
                        --
                        local slider_value = Drawing.new("Text", {Text = text, Parent = slider_frame, Visible = true, Transparency = 1, Color = Color3.new(1,1,1), Size = 13, Center = true, Outline = true, Font = Drawing.Fonts.Plex, Position = UDim2.new(0.5,0,0.5,-6), ZIndex = 8});
                        --
                        local slider_fill = Drawing.new("Square", {Parent = slider_frame, Visible = true, Transparency = 1, Theme = "Accent", Size = UDim2.new(1,0,1,0), Thickness = 1, Filled = true, ZIndex = 7, Position = UDim2.new(0,0,0,0)});
                        local slider_drag_bar = Drawing.new("Square", {Parent = slider_fill, Visible = true, Transparency = 0.5, Color = Color3.new(0.168627, 0.168627, 0.168627), Size = UDim2.new(0,10,1,-2), Thickness = 1, Filled = true, ZIndex = 7, Position = UDim2.new(1,-12,0,1)});
                        --
                        local slider_drag = Drawing.new("Square", {Parent = slider_frame, Visible = true, Transparency = 0, Size = UDim2.new(1,0,1,0), Thickness = 1, Filled = true, ZIndex = 8, Position = UDim2.new(0,0,0,0)});
                        --[[
                        local minus = Drawing.new("Text", {Text = "-", Parent = holder, Visible = true, Transparency = 1, Color = Color3.new(1,1,1), Size = 13, Center = false, Outline = true, Font = Drawing.Fonts.Plex, Position = UDim2.new(0,0,0,10), ZIndex = 7});
                        local plus = Drawing.new("Text", {Text = "+", Parent = holder, Visible = true, Transparency = 1, Color = Color3.new(1,1,1), Size = 13, Center = false, Outline = true, Font = Drawing.Fonts.Plex, Position = UDim2.new(1,-6,0,10), ZIndex = 7});
                        --
                    ...
                    function multi_container_tbl:new_dropdown(cfg)
                        ...
                        --
                        local holder = Drawing.new("Square", {Transparency = 0, ZIndex = 7,Size = UDim2.new(1, 0, 0, 15),Parent = multi_multicontent});
                        if allow_tool then
                            tooltip(cfg, tooltip_text, holder)
                        end
                        --
                        ...
                        local title_shadow = Drawing.new("Text", {
                            Text = name,
                            Font = Drawing.Fonts.Plex,
                            Size = 13,
                    ...
                    function multi_container_tbl:new_keybind(cfg)
                        ...
                        local shadowtitle = Drawing.new("Text", {
                            Text = name,
                            Font = Drawing.Fonts.Plex,
                            Size = 13,
                            Position = UDim2.new(0, 105, 0, 1),
                        ...
                        if allow_modes then
                            local mode_frame = Drawing.new("Square",{
                                Color = Color3.fromRGB(13,13,13),
                            ...
                            local holdbutton = Drawing.new("Square",{
                                Color = Color3.new(0,0,0),
                            ...
                            local remove = Drawing.new("Square", {Filled = true, Position = UDim2.new(1,-20,0,3),Thickness = 1, Transparency = 0, Visible = true, Parent = frame, Size = UDim2.new(0,utility.textlength("x", 2, 13).X + 10, 0, 10), ZIndex = 13});
                            remove.MouseButton1Click:Connect(function()
                                mode_frame.Visible = true
                            end)
            
                            local removetext = Drawing.new("Text", {
                                Font = Drawing.Fonts.Plex,
                                Size = 13,
                                Color = Color3.fromRGB(255,255,255),
                            ...
                            local removetext_bold = Drawing.new("Text", {
                                Font = Drawing.Fonts.Plex,
                                Size = 13,
                                Color = Color3.fromRGB(255,255,255),
                    ...
                    function multi_container_tbl:new_button(cfg)
                        ...
                        function button_tbl:new_button(cfg)
                            ...
                            local callback = cfg.callback or cfg.Callback or function() end;
                            --
                            local button_frame = Drawing.new("Square",{
                                Color = Color3.fromRGB(13,13,13),
                                Size = UDim2.new(0, utility.textlength(button_name, 2, 13).X + 5, 0, 15),
                                Filled = true,
                                Parent = holder,
                ...
                function container_tbl:new_toggle(cfg)
                    ...
                    local toggled = false;
                    -- drawings
                    local holder = Drawing.new("Square", {Parent = multicontent, Visible = true, Transparency = 0, Size = UDim2.new(1,0,0,8), Thickness = 1, Filled = true, ZIndex = 7});
                    --
                    if allow_tool then
                       tooltip(cfg, tooltip_text, holder)
                    end
                ...
                function container_tbl:new_slider(cfg)
                    ...
                    local tooltip_text = cfg.tip_text or cfg.Tip_Text or '';
                    -- drawings
                    local holder = Drawing.new("Square", {Parent = multicontent, Visible = true, Transparency = 0, Size = UDim2.new(1,0,0,15), Thickness = 1, Filled = true, ZIndex = 7});
                    --
                    if allow_tool then
                       tooltip(cfg, tooltip_text, holder)
                    end
                ...
                function container_tbl:new_dropdown(cfg)
                    ...
                    --
                    local holder = Drawing.new("Square", {Transparency = 0, ZIndex = 7,Size = UDim2.new(1, 0, 0, 15),Parent = multicontent});
                    if allow_tool then
                       tooltip(cfg, tooltip_text, holder)
                    end
                    --
            ...
            function section_table:new_slider(cfg)
                ...
                local val = default;
                -- drawings
                local holder = Drawing.new("Square", {Parent = content, Visible = true, Transparency = 0, Size = UDim2.new(1,0,0,15), Thickness = 1, Filled = true, ZIndex = 7});
                --
                local slider_frame = Drawing.new("Square",{
                    Color = Color3.fromRGB(13,13,13),
                    Size = UDim2.new(0, 150, 0, 15),
            ...
            function section_table:new_dropdown(cfg)
                ...
                --
                local holder = Drawing.new("Square", {Transparency = 0, ZIndex = 7,Size = UDim2.new(1, 0, 0, 15),Parent = content});
                if allow_tool then
                   tooltip(cfg, tooltip_text, holder)
                end
                --
